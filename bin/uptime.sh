...
PRINTF='END {printf "SystemUpTimeDays=%s SystemUpTimeHours=%s SystemUptimeMins=%s\n", UPTIMEDAYS, UPTIMEHOURS, UPTIMEMINS}'
...
if [ "x$KERNEL" = "xLinux" -o "x$KERNEL" = "xAIX" -o "x$KERNEL" = "xHP-UX" -o "x$KERNEL" = "xDarwin" -o "x$KERNEL" = "xFreeBSD" -o "x$KERNEL" = "xSunOS" ] ; then
